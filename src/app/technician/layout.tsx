...
import { LayoutDashboard, CheckSquare, LogOut, Menu, X, Home, FileText } from "lucide-react";
    ...
    <div className="min-h-screen flex bg-slate-50 relative">
      ...
      `}>
        ...
        <nav className="p-4 space-y-2">
          ...
          <NavLink href="/discovery" icon={<FileText />} label="Discovery History" active={pathname?.startsWith('/discovery')} onClick={() => setIsSidebarOpen(false)} />
